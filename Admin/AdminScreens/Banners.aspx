...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <!--------------------------line2  ----------------->
           ...
           <div class="col-sm-3">
               ...
               <asp:FileUpload ID="FileuploadImage" runat="server"   AllowMultiple="true" />  
                ...
                <asp:Button ID="upl" runat="server" CssClass="btn btn-primary" Text="upload" OnClick="upl_Click"
       ...
       <%--<asp:Button ID="submitt" runat="server" Class="btn btn-info" Text="Submitt"  OnClick="submitt_Click_bann1" />--%>
           <asp:Button ID="bannsubmt" runat="server" Class="btn btn-info"  text="submitt" OnClick="bannsubmt_Click" />
