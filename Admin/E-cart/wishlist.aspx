<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="wishlist.aspx.cs" Inherits="Admin.E_cart.wishlist" %>
    ...
    <div class="container">
            <div class="navbar navbar-expand-lg">
                    ...
                    <a href="index1.aspx" class="navbar-brand">
                        <img src="assets/images/demos/demo-2/logo.png"  alt="Molla Logo" class="gvrlogo" />
                    </a>
					...
					<table class="table table-wishlist table-mobile">
						...
						<tbody>
							<tr>
                                   ...
                                   <asp:Panel ID="panl_wishlist" runat="server" >
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="assets/images/logo.png" class="gvrlogo" alt="Footer Logo"/>
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="margin-top: 270px; background-color: ghostwhite;">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel1" style="text-align: center;">Removed to Wishlist</h4>
                        &nbsp;&nbsp;
                    ...
                    <br />
                    <div class="modal-body">
                        Item has been Removed to the Wishlist successfully.
                    </div>
                    <br />
