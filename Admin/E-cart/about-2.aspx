<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about-2.aspx.cs" Inherits="Admin.E_cart.about_2" %>
             ...
             <div class="container ">
                 ...
                 <div class="row p-3">
                     <div class="col-lg-6 mt-lg-5  ">
                         ...
                         <h4 class="wel text-warning "><b>Welcome To GVR E-Cart</b>  </h4>
                         <h6>Considering branding but create a better customer experience.<br/>
                             Informing brand integration to make users into advocates.<br/>
                             Informing awareness and above all, make users into advocates.<br/>
                             Creating user stories to improve overall outcomes.
                         </h6>

                         <p><b>> </b>Build Your Customer Aware </p>
                         <p><b>> </b>Grow Awareness & Visibility</p>
                         <p><b>> </b>Customer Support</p>
                         <p><b>> </b>Property Lisiting</p>
                     </div>


                     <div class="col-lg-5 p-3">
                         <img src="../seller%20login/images/img1.jpg" alt="" class="img-fluid abtimg " />
                     </div>
                 </div>
             </div>
         </div>
...
<!==============================================>
         ...
         <div class="container-fluid ">
             <div class="container ">
                 ...
                 <div class="row p-3">
                     <div class="col-lg-5 p-3">
                         <img src="../banner/about1.jpg" alt="" class="img-fluid abtimg " />
                     </div>

                     <div class="col-lg-6  mt-3 ">
                         <p><b>
                             Considering branding but create a better customer experience.<br/>
                             Informing brand integration to make users into advocates.<br/>
                             Informing awareness and above all, make users into advocates.<br/>
                             Creating user stories to improve overall outcomes. </b>
                         </p>
             ...
             <div class="container ">
                 ...
                 <div class="row p-3">
                     ...
                     <div class="col-lg-6  mt-3 ">
                       ...
                       <div class="col-lg-5 p-3">
                           <img src="../banner/about2.jpg"  alt="" class="img-fluid abtimg " />
                     </div>
                 </div>
             </div>
         </div>
                      ...
                      <div class="col-lg-4 col-sm-6">
                          <div class="icon-box icon-box-sm text-center">
                              ...
                              <div class="icon-box-content">
                                  <h3 class="icon-box-title">Quality Product</h3>
                                  <!-- End .icon-box-title -->
                                  <p>
                  ...
                  <div class="row">
                      <div class="col-lg-10 offset-lg-1">
                          ...
                          <div class="brands-display">
                               <h3 class="brands-text text-center mx-auto mb-6">Our Sponsers</h3>

                              <div class="row justify-content-center">
                                  <div class="col-6 col-sm-4 col-md-3">
                                      <a href="#" class="brand">
                                          <img src="assets/images/brands/havells_1.jpg" alt="Brand Name" />
                                      </a>
                                  </div>
                                  ...
                                  <div class="col-6 col-sm-4 col-md-3">
                                      <a href="#" class="brand">
                                          <img src="assets/images/brands/crompton_1.jpg" alt="Brand Name" />
                                      </a>
                                  </div>
                                  <!-- End .col-md-3 -->
                                  ...
                                  <div class="col-6 col-sm-4 col-md-3">
                                      <a href="#" class="brand">
                                          <img src="assets/images/brands/L_T_switchgear_1_1.jpg" alt="Brand Name" />
                                      </a>
                                  </div>
                                  <!-- End .col-md-3 -->
                                  ...
                                  <div class="col-6 col-sm-4 col-md-3">
                                      <a href="#" class="brand">
                                          <img src="assets/images/brands/finolex.jpg" alt="Brand Name" />
                                      </a>
                                  </div>
                                  <!-- End .col-md-3 -->
                                  ...
                                  <div class="col-6 col-sm-4 col-md-3">
                                      <a href="#" class="brand">
                                          <img src="assets/images/brands/GM_1.jpg" alt="Brand Name" />
                                      </a>
                                  </div>
                                  <!-- End .col-md-3 -->
                              </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="widget-list">
                                <li><a href="about-2.aspx">About Molla</a></li>
