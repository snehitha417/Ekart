...
{
    public partial class Browse_Sockets : System.Web.UI.Page
    {
...

        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString1))
            {
                ...
                SqlCommand command = new SqlCommand(" pro_get_FiltersSocket", connection);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    rp_socketsproducts.DataSource = ds;
                    rp_socketsproducts.DataBind();
