<%@ Page Language="C#" EnableEventValidation="False" AutoEventWireup="true" CodeBehind="Browse-Cables-Wires.aspx.cs" Inherits="Admin.E_cart.Browse_Cables_Wires" %>
            ...
            <div class="tab-pane p-0 fade show active" id="top-all-tab" role="tabpanel" aria-labelledby="top-all-link">
                <div class="products">
                    <div class="row justify-content-center">
                        ...
                        <asp:Repeater runat="server" ID="rp_cableswires">
                            <ItemTemplate>
