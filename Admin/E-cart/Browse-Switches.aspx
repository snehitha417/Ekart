<%@ Page Language="C#" EnableEventValidation="False" AutoEventWireup="true" CodeBehind="Browse-Switches.aspx.cs" Inherits="Admin.E_cart.Switches" %>
            ...
            <div class="container mt-5">
                <div class="heading heading-center mb-3">
                    ...
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="top-fur-link" data-toggle="tab" href="Browse-Fans.aspx" role="tab" aria-controls="top-fur-tab" aria-selected="false">Furniture</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="tab-pane p-0 fade show active" id="top-all-tab" role="tabpanel" aria-labelledby="top-all-link">
                <div class="products">
                    <div class="row justify-content-center">
                        ...
                        <asp:Repeater runat="server" ID="rp_Switchesproducts">
                            <ItemTemplate>
