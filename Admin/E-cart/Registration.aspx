<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Admin.E_cart.Registration" %>
     ...
     <!------------------------------form  STARTS HERE--------------------------->
             ...
             <div id="frm" class="continer p-3">
               <div class="row">
                  <div class="col-sm-6 ">
                     ...
                     <asp:TextBox ID="txt_firstName" runat="server" Class="form-control" style="  height: 2.2rem; width: 14.5rem;" />
                ...
                <div class="col-sm-6">
                     ...
                     <asp:TextBox ID="txt_LastName" runat="server" Class="form-control" style="  width: 14.5rem;  height: 2.2rem;"/>
            ...
            <div class="row">
                <div class="col-sm-6">
                     ...
                     <asp:TextBox ID="txt_EmailId" runat="server" Class="form-control" TextMode="Email" style=" width: 14.5rem;  height: 2.2rem; " />
...
<%--                <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="TextBox3" ErrorMessage="Invalid email Format"></asp:RegularExpressionValidator>--%>
               ...
               <div class="col-sm-6">
                 ...
                 <div class="row">
                   <div class="col-sm-6">
                      <asp:Label runat="server" ID="num" class="pn">User ID </asp:Label>
                       <asp:TextBox ID="txt_userid" runat="server"  Class="form-control" style=" width:14.5rem;  height:2.2rem;" />
                  ...
                  <div class="col-sm-6">
                      <asp:Label runat="server" ID="datebirth" class="pn">DOB </asp:Label><br />
                       <asp:TextBox ID="txt_DOB" runat="server" Class="form-control" TextMode="Date" style=" width:14.5rem;  height: 2.2rem;" />
                  ...
                  <div class="row">
                   <div class="col-sm-6">
                      <asp:Label runat="server" ID="Label1" class="Pincode">Pincode </asp:Label>
                       <asp:TextBox ID="txt_pincode" runat="server"  Class="form-control" style=" width:14.5rem;  height:2.2rem;" />
                   
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_pincode" ForeColor="Red" ErrorMessage="Please Enter your User ID"  >
                       </asp:RequiredFieldValidator>
                  </div>

                  <div class="col-sm-6">
                      <asp:Label runat="server" ID="Label2" class="Locality">Locality </asp:Label><br />
                       <asp:TextBox ID="txt_locality" runat="server" Class="form-control"  style=" width:14.5rem;  height: 2.2rem;" />

                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_locality" ForeColor="Red" ErrorMessage="Please Enter your Date of Birth">
                      </asp:RequiredFieldValidator>
                  </div>
                 </div>
                   ...
                   <!--------------------------line4---------------------------->
                    <div class="row">
                   <div class="col-sm-12">
                      <asp:Label runat="server" ID="Label5" class="Address">Addresss </asp:Label>
                       <asp:TextBox ID="txt_add" runat="server"  Class="form-control" style="height:2.2rem;" />
                   
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_add" ForeColor="Red" ErrorMessage="Please Enter your User ID"  >
                       </asp:RequiredFieldValidator>
                  </div>
                        </div>
                  ...
                  <div class="row">
                   <div class="col-sm-6">
                      <asp:Label runat="server" ID="Label3" class="Address">State </asp:Label>
                       <asp:TextBox ID="txt_state" runat="server"  Class="form-control" style="width:14.5rem;  height:2.2rem;" />
                   
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_state" ForeColor="Red" ErrorMessage="Please Enter your User ID"  >
                       </asp:RequiredFieldValidator>
                  </div>

                  <div class="col-sm-6">
                      <asp:Label runat="server" ID="Label4" class="pn">City/District </asp:Label><br />
                       <asp:TextBox ID="txt_city" runat="server" Class="form-control" style=" width:14.5rem;  height: 2.2rem;" />

                      <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_city" ForeColor="Red" ErrorMessage="Please Enter your Date of Birth">
                      </asp:RequiredFieldValidator>
                  </div>
                 </div>
                ...
                <div class="col-sm-6">
                     ...
                     <asp:TextBox ID="txt_password" runat="server" Class="form-control" TextMode="Password"  style=" width: 14.5rem;  height: 2.2rem;" />
                   ...
                   <div class="col-sm-6">
                     ...
                     <asp:TextBox ID="txt_confmpassword" runat="server"  Class="form-control" TextMode="Password" style=" width: 14.5rem;  height:2.2rem;" /> 
       ...
       <asp:Button ID="btn" runat="server" CssClass="btn btn-info" Text="Register"  style="
            width: 165px; margin-left:147px; border-radius: 0.4rem;" OnClick="reg_click_submit" />
