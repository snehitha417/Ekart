...
{
    public partial class Browse_Cables_Wires : System.Web.UI.Page
    {
...

        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString1))
            {
                ...
                SqlCommand command = new SqlCommand(" pro_get_FilterWires", connection);
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    rp_cableswires.DataSource = ds;
                    rp_cableswires.DataBind();
